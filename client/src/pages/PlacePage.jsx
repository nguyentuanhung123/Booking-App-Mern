...
const PlacePage = () => {
    ...
    if(showAllPhotos) {
        return(
            // Không thể để fixed vì để nó thì ta không thể scroll ảnh lên xuống được
    ...
    return(
        <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-8">
            ...
            <a className="flex gap-1 my-3 font-semibold underline" target="_brank" href={'https://maps.google.com/?q='+place.address}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div className="bg-white -mx-8 px-8 py-8 border-t">
                ...
                {/* Sử dụng các tiện ích leading-{size} để cung cấp cho một phần tử chiều cao dòng cố định, bất kể kích thước phông chữ hiện tại. Những điều này rất hữu ích khi bạn cần kiểm soát rất chính xác kích thước cuối cùng của một phần tử. */}
