                ...
                action === 'new' && (
                    <div>
                        <form>
                            ...
                            <p className="text-gray-500 text-sm">Title for your place. Should by short and catchy as in advertisement</p>
                            <input type="text" placeholder="title , for example: My lovely appointment"/>
                            ...
                            <p className="text-gray-500 text-sm">Select all the perks of yout place</p>
                            <div>
                                <div>
                                    <label>
                                        <input type="checkbox"/>
